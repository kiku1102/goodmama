...
function ProductList() {
  ...
  useEffect(() => {
    getData(
      `https://shop24hbackend.vercel.app/products?name=${filterInfo.name}&type=${filterInfo.type}&promotionPriceMax=${filterInfo.promotionPriceMax}&promotionPriceMin=${filterInfo.promotionPriceMin}`
    )
      .then((data) => {
